...
import com.panti.asuhan.DTO.BeritaDTO;
import com.panti.asuhan.model.Berita;
import com.panti.asuhan.response.CommonResponse;
import com.panti.asuhan.service.BeritaService;
...
@RestController
@RequestMapping("/pantiasuhan/api/berita")
@CrossOrigin(origins = "*")
